...
Configuration on the Shopify side happens through configuration in your Shopify Partner Dashboard. Ensure you have an account with admin access in Shopify. 
