...
customButton
<ParamField query="targetElement" type="HTMLElement" default="none" required>
<ParamField query="config" type="IWidgetConfig" default="none" required>
...
showPrompt
<ParamField query="promptType" type="PromptTypes | IWidgetConfig" default="PromptTypes.ReturningUser" required>
...
authButton
<ParamField query="element" type="HTMLElement" default="none" required>
<ParamField query="config" type="IWidgetConfig" default="none" required>
...
<ParamField query="length" type="number" default="none" required>
<ParamField query="numberCapitalised" type="number" default="1" required>
<ParamField query="numberNumbers" type="number" default="1" required>
...
auth
<ParamField query="loginId" type="string | IPartialConfig" default="none" required>
<ParamField query="config" type="IPartialConfig" default="none">
● Runs the main auth flow
</ParamField>

reauth
<ParamField query="loginId" type="string" default="none" required>
<ParamField query="config" type="IPartialConfig" default="none">
● Runs reauth flow
