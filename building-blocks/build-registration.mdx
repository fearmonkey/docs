...
The SDK **register** method is used to integrate the registration journey. It references the field Ids in your existing registration form. It also renders the OwnId widget automatically referncing your field Ids to calculate its position in the DOM.  
