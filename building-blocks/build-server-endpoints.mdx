...
<Info> 
**NOTE** There's an optional 4th endpoint you can build to support post-login enrollment offers for mobile users only.
</Info> 
...
- Post Login Enrollment (optional) - `tbd`
...
### Endpoint 4 - Post Login Enrollment (optional)

This endpoint handles the reuirements of post login enrollment for mobile users.
