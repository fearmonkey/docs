...
Integration with Salesforce Commerce Cloud (SFCC) gives you full access to the OwnID features that simplify and streamline the login experience for your users.

## How it Works

OwnID integrates with the SFCC built-in API client, using our native SFCC Connector and an SFCC _cartridge_.

Integrate OwnID with SFCC using these three basic steps:
...
4. Add the following JSON object to the _data_ tab:
