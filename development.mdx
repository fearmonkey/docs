...
We provide code templates for the event handlers needed by your server-side endpoints. Login events in your frontend trigger the OwnID server to make HTTP requests to these. 
