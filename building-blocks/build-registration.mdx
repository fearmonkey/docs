...
The submit button in the form triggers the `regClick()` function defined below. 
...
Your users can now register a new account through OwnId platform services.
