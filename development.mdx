...
_The initial workflow to build is typically 'Login', as described on this page. That gives you both 'go live' functionality and provides the code base you need to quickly implement 'Registration' and 'Password Recovery' workflows when you're ready._
...
setTranslations
<ParamField query="languages" type="{ [langKey: string]: ITranslation }" default="none" required>
Sets translations for translation service.
For internal use.
</ParamField>
