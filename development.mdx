...
_We recommend you build the user 'Login' journey first, as described on this page. That gives you sufficient functionality to 'go live' and provides the code base you need to quickly implement 'Registration' and 'Password Recovery' when you're ready._
