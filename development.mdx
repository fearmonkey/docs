...
Here, your existing web server hosts the endpoints. We provide code templates for each related event handler (see below).
...
This endpoint handles a request to save an OwnIdData record for a given email address.
