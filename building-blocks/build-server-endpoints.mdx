...
<Info> 
**NOTE** There's an optional 4th endpoint you can build to support post-login enrollment offers.
</Info> 
...
This endpoint handles the reuirements of post login enrollment.
