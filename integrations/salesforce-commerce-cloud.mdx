...
OwnID integrates with Salesforce Commerce Cloud (SFCC) through their built-in API client, using our SFCC Connector.
...
1. Add the following JSON to the shop tab:
...
4. Add the following JSON to the _shop_ tab:
