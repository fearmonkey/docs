...
Your OwnID Apps act as a central point of configuration for each of your integrations. They are created (no-code), hosted, and maintained entirely within the OwnID Console environment.

 <img
    src="/images/oi-widg-s.png"
    width="200"
    alt="Profile editor"
/>
<sup> OwnID widget </sup>

When you create an OwnID App in the Console, it's assigned a unique `appId`. Use that `appId` in OwnID SDK interaction from your website’s front end.
