...
1. From the _OwnID Settings_ panel, copy the _App ID_ and the _Shared Secret_ values for later use.<Check>Your OwnID application and secret key are created and you're ready for next steps!</Check>
