...
Below is an outline of the three major steps required to implement end-to-end login workflow. 
...
The user Login id (typically the user email address) is the unique identifier used to look up and save records in the OwnIdData field.
