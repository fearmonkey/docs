...
Integration with Shopify gives you full access to the OwnID features that simplify and streamline the login experience for your users.
...
Integrate CDC with OwnID in four basic steps:
...
8. Under **Admin API access scopes** you'll see many categories. Scroll down until you reach **Customers**, or search for "Customers" in the search bar. Here, you'll click to tick the boxes for 'write_customers' and 'read_customers', then click the **Save** button. 

<Frame>
  <img src="/images/shop9.png" alt="Shopify Customer Accounts"></img>
</Frame>

8. Go to the **API Credentials** and click on **Install** in the Access tokens box. The Admin API Access Token is generated. Click on **Reveal token once** to see the token as plain text. Make a copy to use during onboarding in the OwnID console.
<Frame>
