...
Our connectors are prebuilt, low-code integrations to selected IAMs. If a connector isn't available for your specific IAM, the API/SDK provides an integration path with even more flexibility, customization, and control.
