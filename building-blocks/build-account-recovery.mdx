...
## Prerequisites
To get the most out of this guide, you should first add the three required event handlers to your web server as described in [Build Server Endpoints](/building-blocks/build-server-endpoints).
...
3. Step 3 - Implement Account Recovery Form
...
## Step 3 - Implement Account Recovery Form
