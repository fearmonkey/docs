...
<Note>Skip to [Step 2](#step-2.-add-web-server-end-points) if you already have the items below. </Note>
...
### STEP 2. Add web server end-points
...
1. **Install and reference web sdk**. If you're using Angular or React, install the OwnID Web SDK for your framework. Reference the SDK on your login page.
2. Add the OwnID password widget. 
3. Instantiate the call to the Web SDK on the login event.
