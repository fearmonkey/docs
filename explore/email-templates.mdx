...
1. Click the **Branding** menu from the left side navigation panel. <img src="/images/oi-console-branding.png" width="200"  alt="Console branding link"></img>


1. Select **Email templates** from the dropdown options. The _Email templates_ page opens. <img src="/images/oi-et-main.png" width="400"  alt="Console branding link"></img>
...
1. The existing template for the selected type appears.<img src="/images/oi-et-preview_ml.png" width="400"  alt="Console branding link"></img>
...
```
7. Click **Preview** to check what recipients will see.   <img src="/images/oi-et-preview_ml.png" width="600"  alt="Console branding link"></img>
