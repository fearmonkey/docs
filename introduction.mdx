...
Connectors are prebuilt integrations to selected IAMs. The API provides an integration path when a connector isn't available, as well as more flexibility, customization, and control for developers.
