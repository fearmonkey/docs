...
Here, your existing web server is the host. When a user logs in, your frontend makes standard HTTP requests to the web server,  which processes them using request handlers provided by OwnID. 
...
The following data elements are used to build login worflows:
