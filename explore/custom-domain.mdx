...
The important thing is that the URL your users see  reflects your brand such as `passwordless.your_domain.com` instead of `passwordless.ownid.com`.
...
In case you are not sure, you can use a [DNS Lookup](https://mxtoolbox.com/DnsLookup.aspx) tool and enter your domain. It might tell you who your DNS provider is (but not always).

### Create required DNS records

These are general instructions for creating your DNS records. If you have issues with any of the steps, please contact your DNS provider for more assistance:
