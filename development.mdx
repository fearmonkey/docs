...
Each step in the 'Login' integration process is explained in detail below.
### STEP 1 - Preparation
...
This process and some best-practice recommendations are covered in our Security guide.
