...
<Steps>
  ...
  Add our HTML and JavaScript templates to build the login workflow and install the OwnID Password widget.
  </Step> 
</Steps>
...
<Card title="Build Server Endpoints" href="/building-blocks/build-server-endpoints">
When the OwnID server receives authentication events from your frontend, it then makes the appropriate HTTP requests to these endpoints.
</Card>
