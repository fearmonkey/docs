...
Integration with Okta gives you full access to the OwnID features that simplify and streamline the login experience for your users.
...
Integrate OwnID with Okta in four basic steps:
