...
2. Loninn to the OwnID Console, select the app you want to configure, then click the _Custom Domain_ tab to start the domain connection process.

3. On the Custom Domain page, click **Set up your own**. Enter the entire your for your subdomain. After entering your desired subdomain, a panel with instructions for setting up your DNS records will appear:
...
To start, figure out which service is managing your DNS records, so you know exactly where to login and create the new records.
...
These are generalized instructions for creating your DNS records. But providers do vary, and if you have issues with any of the steps, contact your DNS provider for more assistance.
...
**Find Your DNS Management UI**

Now that you're logged in, find where you manage the DNS records for your domain in your provider's control panel.
