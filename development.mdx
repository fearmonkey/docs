...
_Your first workflow integration is typically 'Login', as described below. That both gives you 'go live' functionality and provides the code base you need to quickly implement 'Registration' and 'Password Recovery' workflows._
