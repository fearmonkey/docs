...
<Note>Skip to [Step 2](#add-web-server-endpoints) if you already have the items below. </Note>
...
<Info>
- Your **account id** - _Use this in data objects where specified by the appId field._
...
When the OwnID server receives login events from your frontend, it then makes HTTP requests to these endpoints. 
