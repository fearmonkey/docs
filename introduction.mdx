...
If a connector isn't available for your specific identity provoder, the API/SDK provides an integration path with even more flexibility, customization, and control.
