...
Integration with Salesforce Commerce Cloud (SFCC) gives you full access to the OwnID feature set to simplify and streamline the login experience for your users. 

OwnID integrates with SFCC through their built-in API client, using our native SFCC Connector and an SFCC _cartridge_.
