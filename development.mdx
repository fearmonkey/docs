...
Below are code templates for the three event handlers needed by your server-side endpoints. Login events in your frontend trigger the OwnID server to make HTTP requests to these. 
