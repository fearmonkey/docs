...
If a connector isn't available for your specific identity provider, the API/SDK provides an integration path with even more flexibility, customization, and control.
...
- [Explainer: Connectors vs. API](apivconnector)
